function createTransmissionLineCalculator()
    ...
    strandedDropdown = uicontrol('Style', 'popupmenu', 'Position', [260, 520, 200, 20], 'String', {'3-Triangle', '4-Row', '4-Square', '7-Hexagonal', '9-Square'}, 'Callback', @(src, event) updateStrandedImage());
    ...
    bundlingDropdown = uicontrol('Style', 'popupmenu', 'Position', [260, 480, 200, 20], 'String', {'Non-Bundled', 'Bundled (<= 3)', 'Bundled (> 3)'}, 'Callback', @(src, event) updateBundlingImage());
